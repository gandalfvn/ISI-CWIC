...
angular.module('angle').controller('replayCtrl',
  ['$rootScope', '$scope', '$state', '$translate', '$window', '$localStorage', '$timeout', '$meteorCollection', 'ngDialog', 
    function($rootScope, $scope, $state, $translate, $window, $localStorage, $timeout, $meteorCollection, ngDialog){
    "use strict";
      ...
      dialog.closePromise.then(function (data) {
        ...
        if(data && data.value){
          if(data.value.open){
            ...
            console.log('ngDialog closed', $scope.myreplay);
          }
        }
      });
    }
