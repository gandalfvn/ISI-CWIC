...
var validKeys = ['_id', 'public', 'block_meta', 'block_state', 'created', 'name', 'creator', 'type'];
GenCmds.allow({
    insert: function (userId, data) {
        if (isRole(Meteor.user(), 'guest'))
            throw new Match['Error']("Guests may not modify data");
...
//# sourceMappingURL=gencmds.js.map