...
def createData(train=True):
  ...
  log.writelog(("Train " if train else "Test ") + "possible:%d  found:%d  zero:%d" % (ba, bc, zer))
  log.writelog(("Train " if train else "Test ") + "Target: " + str(Target))
  log.writelog(("Train " if train else "Test ") + "Target2: " + str(Target2))
